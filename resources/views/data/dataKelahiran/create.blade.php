...
@section('title', 'Buat Data Kelahiran')
...
@section('breadcrumb', Breadcrumbs::render('datakelahiran.create', $dataKartuKeluarga))
...
@section('base')
  <div class="card card-primary">
    ...
    <form action="{{ route('datakelahiran.store', $dataKartuKeluarga->nomorkk) }}" method="post">
      @csrf
      <div class="card-body">
        ...
        <div class="bs-stepper">
          <div class="bs-stepper-header" role="tablist">
            ...
            <div class="line"></div>
            <div class="step" data-target="#data-kelahiran">
              <button type="button" class="step-trigger" role="tab" aria-controls="data-kelahiran" id="data-kelahiran-trigger">
                <span class="bs-stepper-circle">2</span>
                <span class="bs-stepper-label">Data Kelahiran</span>
              </button>
            </div>
          </div>
          ...
          <div class="bs-stepper-content">
            ...
            <div id="data-kelahiran" class="content" role="tabpanel" aria-labelledby="data-kelahiran-trigger">

              <div class="form-group">
                <label>
                  Anak Ke -
                </label>
                <input type="text" class="form-control" name="nomor_anak" placeholder="Anak Ke-" value="{{ old('nomor_anak') }}">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="keterangan" placeholder="Keterangan Data lahir" value="{{ old('keterangan') }}">
              </div>
