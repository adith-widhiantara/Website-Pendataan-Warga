...
@section('breadcrumb', Breadcrumbs::render('datakelahiran.index'))
          ...
          <div class="modal fade" id="modal-default">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="{{ route('datakelahiran.findNomorkk') }}" method="post">
                  @csrf
        ...
        <tbody>
          @foreach( $dataKelahiran as $data )
            <tr>
              ...
              <td>{{ \Carbon\Carbon::parse($data -> anggotaKeluarga -> tanggal_bulan_tahun_lahir)->isoFormat('Do MMMM YYYY') }}</td>
              <td>{{ $data -> anggotaKeluarga -> nama_ayah }}</td>
              <td>{{ $data -> anggotaKeluarga -> nama_ibu }}</td>
              <td>
                <a href="{{ route('datakelahiran.show', $data->id) }}" class="btn btn-primary">
                  Detail
                </a>
              </td>
            </tr>
