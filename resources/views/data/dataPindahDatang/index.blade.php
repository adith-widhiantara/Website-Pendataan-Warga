...
@section('title', 'Data Pindah Datang')
...
@section('breadcrumb', Breadcrumbs::render('datapindahdatang.index'))

@section('base')
  <div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">
        Daftar Data Pindah Datang
      </h3>
    </div>
    <div class="card-body">
      <div class="row">
          ...
          <div class="modal fade" id="modal-default">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="{{ route('datapindahdatang.findNomorkk') }}" method="post">
                  @csrf
        ...
        <tbody>
          @foreach ( $dataPindahDatang as $data )
            <tr>
              ...
              <td>
                <a class="btn btn-primary" href="{{ route('datapindahdatang.show', $data->id) }}">
                  Detail
                </a>
              </td>
            </tr>
